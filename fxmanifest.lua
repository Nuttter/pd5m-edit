...
ConvarEnableESX = true -- https://forum.cfx.re/t/release-esx-base/39881
...
ConvarEnableDatabase = false -- Enables the json database script of pd5m. Currently saves player outfits.
...
client_scripts {
  "Config/Stations/Police/ArrestLoc.lua",
