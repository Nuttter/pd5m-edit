Mss_Amb_NonRoadWorthyVehicle_Silverman = {
  ...
  Main = function()
    ...
    local targetveh = GetClosestVehicle(pcoords.x+rndx, pcoords.y+rndy, pcoords.z+rndz, 200.0, 0, 70)
    ...
    while IsVehicleSeatFree(targetveh, -1) or IsPedAPlayer(GetPedInVehicleSeat(targetveh, -1)) or not DoesEntityExist(targetveh) do
      ...
      targetveh = GetClosestVehicle(pcoords.x+rndx, pcoords.y+rndy, pcoords.z+rndz, 200.0, 0, 70)
    end
