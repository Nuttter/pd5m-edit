...
-- Callout variables
AmbientEventTriggerChance = 20 -- Chance that an ambient event triggers in a single roll. Rolls every 30 seconds.
...
PedDruggedChance = 17.50 -- Chance that the ped is drugged (standard: 0.50)
PedDrunkChance = 10.00 -- Chance that the ped is drunk (standard: 4.00)
PedWantedChance = 15.00 -- Chance that the ped is wanted (standard: 1.50)
PedNoIDChance = 10.00 -- Chance that the ped has no ID (standard: 1.00)
PedNoDriverLicenceChance = 4.00 -- Chance that the ped has no drivers licence (standard: 4.00)
PedNoWeaponLicenceChance = 30.00 -- Chance that the ped has no weapon permit (standard: 40.00)
...
PedMeleeBaseChance = 1.00 -- Base chance that the ped has a melee weapon (standard: 6.00)
PedLegalWeapBaseChance = 1.00 -- Base chance that the ped has a legal weapon (standard: 5.00)
PedIllegalWeapBaseChance = 1.00 -- Base chance that the ped has an illegal weapon (standard: 4.00)
PedIllegalItemBaseChance = 1.00 -- Base chance that the ped has an illegal weapon (standard: 4.00)
...
-- general variables
ActivateTPfunction = false -- activates the /tp-function.
