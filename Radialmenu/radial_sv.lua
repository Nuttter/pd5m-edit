...
RegisterCommand("pd5m:int:backupcancel", function(s, n, m)
	CancelEvent()
	TriggerClientEvent('pd5m:int:backupcancel', s)
end)
RegisterCommand("pd5m:client:requestbackup", function(s, n, m)
	CancelEvent()
	TriggerClientEvent('pd5m:client:requestbackup', s)
end)